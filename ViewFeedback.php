...
<body>
    ...
    <div class="row">
    <div class="col-md-12">
    <h2 class="text-center text-primary">User's Feedback</h2>
    </div>
    <div class="col-md-12">
    <?php
    ...
    {
    echo "<tr> <form action=deletefeedback.php method=post>";
    echo "<td> <input type=hidden name=id value='".$row['id']."'> </td>";
    echo "<td>".$row['name']."</td>";
    echo "<td>".$row['email']."</td>";
    echo "<td>".$row['mobile']."</td>";
    echo "<td>".$row['message']."</td>";
    echo "<td align=center> <input type=submit class='btn btn-primary' value=delete name=delete> </td>";
    echo "</form></tr>";
    }
    ?>
    </table>
